...
def analyze_conflicts(events):
    ...
    conflict_events = [
        event for event in events if event.get("event_type") == "conflict"
    ]
    ...
    analysis = {
        ...
        "indicators": [],
        "regions": {},
        "assessment": "No significant conflict indicators detected",
    }
    ...
    for event in conflict_events:
        text = (str(event.get("title", "")) + str(event.get("description", ""))).lower()
    ...
    analysis["indicators"] = list(indicator_set)
